      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div className="flex min-h-full items-start justify-center p-4 pt-8">
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="w-full max-w-2xl bg-gradient-to-br backdrop-blur-xl rounded-2xl border shadow-2xl"
            style={{
          ...
          >
            <div className="p-6">
              ...
              <div className="mb-6 p-4 bg-black/20 rounded-lg">
                <h4 className="text-sm font-medium text-gray-300 mb-2">Cognitive Optimization Active</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-gray-400">Brainwave Target:</span>
                  ...
                  <div>
                    <span className="text-gray-400">Visual Metaphor:</span>
                    <div className="text-white font-medium">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium">
                      {sensoryDirectives.motionIntensity}/10
                    </div>
                  </div>
                </div>
              </div>
              ...
              <AnimatePresence>
                {!showFeedback ? (
                  <motion.button
                    ...
                    className="w-full py-3 text-sm text-gray-400 hover:text-white transition-colors border border-white/20 rounded-lg hover:border-white/40 font-medium"
                  >
                  ...
                  <motion.div
                    ...
                    className="space-y-3"
                  >
                    <div className="text-sm font-medium text-gray-300 mb-3">How useful was this insight?</div>
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        onClick={() => handleFeedback('useful')}
                        className="flex items-center justify-center gap-2 py-3 px-4 bg-emerald-600/20 text-emerald-300 rounded-lg hover:bg-emerald-600/30 transition-colors text-sm font-medium"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-2 py-3 px-4 bg-red-600/20 text-red-300 rounded-lg hover:bg-red-600/30 transition-colors text-sm font-medium"
                      >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className="py-3 px-4 bg-amber-600/20 text-amber-300 rounded-lg hover:bg-amber-600/30 transition-colors text-sm font-medium"
                      >
                        Needs More Detail
                      </button>
                      <button
                        onClick={() => handleFeedback('inaccurate')}
                        className="py-3 px-4 bg-gray-600/20 text-gray-300 rounded-lg hover:bg-gray-600/30 transition-colors text-sm font-medium"
                      >
                        Inaccurate
                      </button>
                    </div>
